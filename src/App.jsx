...
import Video from "./Video"; // your tutorial Video.js
import "./App.css";
    ...
    <div className="container">
      ...
      <section className="info">
        ...
        <div className="info-block">
          ...
          <p>
            <strong>65%</strong> of desk workers develop back pain due to poor
            posture, and <strong>42–63%</strong> experience neck strain annually,
            leading to discomfort and lost productivity. <strong>PosturePulse</strong>{" "}
